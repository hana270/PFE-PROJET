...
var MatTab = class _MatTab {
  ...
  constructor(_viewContainerRef, _closestTabGroup) {
    ...
    this._stateChanges = new import_rxjs2.Subject();
    this.position = null;
    this.origin = null;
    this.isActive = false;
  }
...
var MatPaginatedTabHeader = class _MatPaginatedTabHeader {
  ...
  constructor(_elementRef, _changeDetectorRef, _viewportRuler, _dir, _ngZone, _platform, _animationMode) {
    ...
    this._stopScrolling = new import_rxjs2.Subject();
    ...
    _ngZone.runOutsideAngular(() => {
      (0, import_rxjs2.fromEvent)(_elementRef.nativeElement, "mouseleave").pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
        this._stopInterval();
      });
    });
  }
  ngAfterViewInit() {
    (0, import_rxjs2.fromEvent)(this._previousPaginator.nativeElement, "touchstart", passiveEventListenerOptions).pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
      this._handlePaginatorPress("before");
    });
    (0, import_rxjs2.fromEvent)(this._nextPaginator.nativeElement, "touchstart", passiveEventListenerOptions).pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
...
var MatTabBodyPortal = class _MatTabBodyPortal extends CdkPortalOutlet {
  constructor(componentFactoryResolver, viewContainerRef, _host, _document) {
    ...
    this._host = _host;
    this._centeringSub = import_rxjs2.Subscription.EMPTY;
    this._leavingSub = import_rxjs2.Subscription.EMPTY;
  }
...
var MatTabBody = class _MatTabBody {
  ...
  constructor(_elementRef, _dir, changeDetectorRef) {
    this._elementRef = _elementRef;
    this._dir = _dir;
    this._dirChangeSubscription = import_rxjs2.Subscription.EMPTY;
    this._translateTabComplete = new import_rxjs2.Subject();
...
var MatTabGroup = class _MatTabGroup {
  ...
  constructor(_elementRef, _changeDetectorRef, defaultConfig, _animationMode) {
    ...
    this._tabsSubscription = import_rxjs2.Subscription.EMPTY;
    this._tabLabelSubscription = import_rxjs2.Subscription.EMPTY;
...
var MatTabNav = class _MatTabNav extends MatPaginatedTabHeader {
  ...
  constructor(elementRef, dir, ngZone, changeDetectorRef, viewportRuler, platform, animationMode, defaultConfig) {
    super(elementRef, changeDetectorRef, viewportRuler, dir, ngZone, platform, animationMode);
    this._fitInkBarToContent = new import_rxjs2.BehaviorSubject(false);
    this.stretchTabs = true;
    this.disableRipple = false;
    this.color = "primary";
    this.disablePagination = defaultConfig && defaultConfig.disablePagination != null ? defaultConfig.disablePagination : false;
